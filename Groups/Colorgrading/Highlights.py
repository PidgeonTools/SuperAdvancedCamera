...
def create_highlights_group() -> NodeTree:
    ...
    # Create the links
    link_nodes(sac_highlights_group, map_range_node, 0, multiply_node_1, 0)
    link_nodes(sac_highlights_group, map_range_node, 0, multiply_node_2, 0)
    link_nodes(sac_highlights_group, multiply_node_1, 0, subtract_node_1, 1)
    link_nodes(sac_highlights_group, multiply_node_2, 0, subtract_node_2, 0)
    link_nodes(sac_highlights_group, subtract_node_1, 0, multiply_node_3, 0)
    link_nodes(sac_highlights_group, subtract_node_2, 0, multiply_node_4, 0)
    link_nodes(sac_highlights_group, input_node, 0, multiply_node_3, 1)
    link_nodes(sac_highlights_group, input_node, 0, multiply_node_4, 1)
    link_nodes(sac_highlights_group, multiply_node_3, 0, rgb_curves_node_1, 0)
    link_nodes(sac_highlights_group, multiply_node_4, 0, rgb_curves_node_2, 0)
    link_nodes(sac_highlights_group, input_node, 0, rgb_curves_node_1, 1)
    link_nodes(sac_highlights_group, rgb_curves_node_1, 0, rgb_curves_node_2, 1)
    link_nodes(sac_highlights_group, rgb_curves_node_2, 0, output_node, 0)
